...
window.createPicturesAuto = function(api){
  ...
  var exportButton=document.createElement('button');exportButton.textContent='Export Auto copy';exportButton.onclick=function(){
    var blob=new Blob([JSON.stringify({version:A.version,records:records,media:media,additions:A.additions,layout:A.layout||{},manualReview:A.manualReview||{},aliases:A.aliases||[],retiredRecords:A.retiredRecords||[],geometryEdits:changes},null,2)],{type:'application/json'});
